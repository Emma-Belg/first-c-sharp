   ...
   // if you do not specify an access modifier of a class then it is implicitly treated as 'internal'
    public class InMemoryBook : Book, IBook
    {
        ...
        public string Name1
        {
            ...
            //it means that they can only set the name via the constructor (once it is constructed the name cannot be changed)
            private set;
        }
        ...
        public override Statistics GetStatistics()
        {
            ...
            //Same as the below foreach but gives control over when to stop or ignore something
            ...
            //The same code as above, but writen as a foreach
